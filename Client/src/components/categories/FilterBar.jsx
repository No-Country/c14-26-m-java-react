...
const FilterBar = () => {
  return (
    <div className="w-[1440px] h-[98px] relative bg-white">
  <div className="h-[98px] py-6 left-[195px] top-0 absolute flex-col justify-start items-center gap-20 inline-flex">
    <div className="w-[1049px] justify-between items-center inline-flex">
